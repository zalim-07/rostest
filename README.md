...
## Требования
Тема требует установки следующих плагинов:
- **Advanced Custom Fields (ACF)** - для работы с произвольными полями
- **Cyr-To-Lat** (или аналоги) - для корректной работы фильтров
...
**Файл:** `wordpress/demo-data.xml` (13 докторов)

**Инструкция:**
1. Админка → Инструменты → Импорт
2. Выбрать "WordPress" → Установить плагин
3. Запустить импортер
4. Загрузить файл `wordpress/demo-data.xml`
5. Выбрать пользователя для назначения записям
6. Нажать "Отправить"
